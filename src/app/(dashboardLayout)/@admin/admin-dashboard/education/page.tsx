...
import { EducationManager } from "@/components/modules/dashboard/admin/EducationManager";
...
export default function AdminEducationPage() {
  ...
  const fetchEducations = useCallback(async () => {
    ...
    if (error) {
      toast.error("Failed to load education history", { description: error.message });
      setEducations([]);
    } else {
      setEducations(data || []);
    }
