...
const SkillBar: React.FC<SkillBarProps> = ({ skill, index = 0 }) => {
  ...
  switch (level) {
    case "Expert":
      badgeClasses = "bg-green-50 dark:bg-green-500/10 text-green-600 dark:text-green-400 border-green-200 dark:border-green-500/20";
      break;
    case "Recently Learned":
      badgeClasses = "bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-500/20";
      break;
    case "Learning":
      badgeClasses = "bg-orange-50 dark:bg-orange-500/10 text-orange-600 dark:text-orange-400 border-orange-200 dark:border-orange-500/20";
      break;
    default:
      badgeClasses = "bg-gray-50 dark:bg-gray-500/10 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-500/20";
  }
